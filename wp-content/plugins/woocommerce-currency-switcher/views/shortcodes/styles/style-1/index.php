...
<div class="woocs-style-1-dropdown" style="width: <?php echo esc_attr( $width ); ?>;">
	...
	<div class="woocs-style-1-select">
		<span><?php echo esc_html( $options[ $this->current_currency ] ); ?></span>
	...
	<ul class="woocs-style-1-dropdown-menu">
		<?php foreach ( $options as $key => $value ) : ?>
			...
			if ( $key === $this->current_currency and ! $this->shop_is_cached ) {
				continue;}
			?>
			<li data-currency="<?php echo esc_attr( $key ); ?>" data-flag="<?php echo esc_attr( ( isset( $all_currencies[ $key ]['flag'] ) ? $all_currencies[ $key ]['flag'] : '' ) ); ?>" style="
			<?php
